...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await ResumeService.login(formData);
      console.log('Login successful:', response);
      
      // Handle remember me functionality if needed
      if (rememberMe) {
        // Store token with remember me flag
        localStorage.setItem('rememberMe', 'true');
      }
      
      navigate('/generate-resume'); // or your dashboard route
    } catch (error) {
      setErrors({
  ...
  const handleSocialLogin = (provider) => {
    ...
    // You can integrate with ResumeService.socialLogin(provider) if available
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to continue to AI Resume Builder
          </p>
        </div>
        ...
        <div className="bg-white py-8 px-6 shadow-2xl rounded-2xl sm:px-10 border border-gray-100">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  } rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-colors duration-200`}
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button
                ...
                disabled={isLoading}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200 disabled:opacity-50"
              >
          ...
          <p className="mt-4 text-center text-xs text-gray-500">
            ...
            <a href="/terms" className="text-gray-700 hover:text-blue-600">Terms of Service</a>{' '}
            and{' '}
